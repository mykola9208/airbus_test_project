...
FAST_PREDICTION = True  # використовується для більш швидкої перевірки роботи програми
FAST_PREDICTION_SIZE = 1000
...
# зберегаємо у необхідний файл, але я зберігаю у інший файл, щоб не змінювати кількість рядків у файлі sample_submission_v2.csv
